 ...
 */
define('GRAPHINA_CHARTS_FOR_ELEMENTOR_VERSION', '1.8.3');
...
(new Graphina_Charts_For_Elementor_Admin('1.8.3'));
...
add_action( 'admin_notices', function() {
    if(isGraphinaProInstall() && isGraphinaPro() && (version_compare(graphinaGetPluginVersion('graphina-pro-charts-for-elementor'),'1.4.2', '<'))) {
        echo '<div class="notice notice-warning is-dismissible">
              <p style="font-size: 15px;"><b><span style="color:#b10101;">Important:</span> The latest graphina plugin (version 1.8.3) requires the latest graphina pro (version 1.4.2). Please update the graphina pro to the latest version. Click <a href="https://themeforest.net/downloads" target="_blank">here</a> to download the latest version.</b></p>
              </div>';
    }
} );
