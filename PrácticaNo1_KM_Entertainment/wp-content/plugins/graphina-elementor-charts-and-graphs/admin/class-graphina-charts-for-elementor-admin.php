...
class Graphina_Charts_For_Elementor_Admin{
    ...
    public function enqueue_scripts(){
        ...
        if ($pagenow === 'admin.php' && !empty($current_page) && ($current_page == 'graphina-chart' || $current_page == 'graphina-chart-pro')) {
            wp_enqueue_media();
    ...
    public function pro_page(){
        ...
        <div style="background: #2A2A31; padding: 50px 0; border-radius: 20px; margin: 20px 20px 0  0;">
            <img src="<?php echo GRAPHINA_URL; ?>/admin/assets/images/graphina_banner.jpg"
                style="width:80%; display: block; margin-left: auto; margin-right: auto; border-radius: 20px;">
            <img src="<?php echo GRAPHINA_URL; ?>/admin/assets/images/graphina_pro.jpg" style="width:80%; display: block; margin-left: auto; margin-right: auto; margin-top: 20px; border-radius: 20px;">
            <a href="https://codecanyon.net/item/graphinapro-elementor-dynamic-charts-datatable/28654061"
                style="display: block; text-align: center; margin: 50px 0px 50px 0px;"
                target="_blank">
                                            ...
                                            <div class="col">
                                                <div class="graphina_card">
                                                    <div class="graphina_card_body">
                                                        ...
                                                        <a href="https://apps.iqonic.design/docs/product/graphina-elementor-charts-and-graphs/" class="graphina_document_button" target="_blank" ><?php  echo __("Documentation", "graphina-charts-for-elementor") ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
